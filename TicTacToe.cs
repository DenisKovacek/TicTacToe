...
namespace TicTacToe
{
    public partial class TicTacToe : Form
    {
        ...
        {
            //need to add all buttons inside panel 2
        ...
        public void btn_click(object sender, EventArgs e)
        {
            ...
            if (btn.Text.Equals(""))//clear text from buttons later
            {
        ...
        public void getTheWinner()
        {
            ...
            if (!button7.Text.Equals("") && button1.Text.Equals(button4.Text) && button1.Text.Equals(button7.Text))
            {
            ...
            //if no one wins and all button not empty
